...
var Comment = (_dec = (0, _typeorm.Entity)("comments"), _dec2 = (0, _typeorm.PrimaryGeneratedColumn)("increment"), _dec3 = (0, _typeorm.ManyToOne)("User", "comments"), _dec4 = (0, _typeorm.ManyToOne)("Post", "comments"), _dec5 = (0, _typeorm.Column)("text"), _dec6 = (0, _typeorm.CreateDateColumn)(), _dec7 = (0, _typeorm.UpdateDateColumn)(), _dec(_class = (_class2 = (_temp = function Comment() {
  (0, _classCallCheck2["default"])(this, Comment);
  (0, _initializerDefineProperty2["default"])(this, "id", _descriptor, this);
  (0, _initializerDefineProperty2["default"])(this, "user", _descriptor2, this);
  (0, _initializerDefineProperty2["default"])(this, "post", _descriptor3, this);
  ...
  writable: true,
  initializer: null
}), _descriptor2 = (0, _applyDecoratedDescriptor2["default"])(_class2.prototype, "user", [_dec3], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor3 = (0, _applyDecoratedDescriptor2["default"])(_class2.prototype, "post", [_dec4], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
